SELECT C.CustomCIS2 AS 'Work_Request_Number'
	...
	, RIGHT((SELECT TOP 1 JE.Description FROM JobEvent JE WHERE J.JobId = JE.JobId AND JE.Title LIKE 'Assigned'), LEN((SELECT TOP 1 JE.Description FROM JobEvent JE WHERE J.JobId = JE.JobId AND JE.Title LIKE 'Assigned'))-11) AS 'Installer'
