SElECT J.EndTime AS 'Job Completion Time'
	, CASE WHEN C.Address = 'Awaiting data update' 
		THEN (SELECT TOP 1 Address FROM UtilityCustomer UI WHERE C.LegacyMeterSerial = UI.LegacyMeterSerial )
...
--AND J.EndTime BETWEEN @StartDate AND @EndDate
